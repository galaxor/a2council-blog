...
{% include infobox.html 
  ...
  wrapup  = "/posts/a2council-wrapup-2023-04-03/"
%}
...
{% include map.html boxid="n-maple-apts" caption="Interactive Map: Proposed Site of North Maple Apartments" text="Proposed site of N Maple Apts" lat=42.29890735421941 lon=-83.78157303066777 zoom=16 %}
