...
We finally got to see the city administrator's [budget presentation](http://a2gov.legistar.com/LegislationDetail.aspx?ID=6122664&GUID=6B3491D0-5C3A-45CC-90E4-3FFE304AA06B&Options=&Search=).  I'll walk you through it and give my thoughts.  The contract for the comprehensive land use plan update was approved, with strong language about redressing segregation in our new plan, and also with the assumption that we will be creating density.  Also, the 415 W Washington rezoning and concept plan were approved.
...
Here is the [complete proposed city budget](https://www.a2gov.org/departments/finance-admin-services/financial-reporting/Documents/Draft%20Budget%20Book%20FY24.25.pdf).

But let's see what the city administrator chose to highlight in his presentation at this meeting.

{% include image.html
  src = "/assets/2023-04-17/budget/overview.jpg"
  alt = "Presentation slide. Title: City administrator's proposed FY24-25 budget.  Text:  All funds budget = $563,666,318.  General Fund (GF) = $129,232,651."
  caption = "Overview slide from the budget presentation."
%}
...
{% include image.html
  src = "/assets/2023-04-17/budget/throne.jpg"
  alt = "Presentation slide.  A photo of a bathroom stall in a public plaza in some other city. It says 'Throne: your clean bathroom.' Title: Downtown commitment. Text: Public restrooms. $200k - ARPA. Pilot. Partnership with DDA. Public Engagement / Placement Analysis."
  caption = "A 'Throne' bathroom in some other city.  This one has steps, but city administrator Dohoney assured us that we would get a barrier-free version for Ann Arbor."
%}
...
{% include image.html
  src = "/assets/2023-04-17/budget/121-e-catherine.jpg"
  alt = "Presentation slide. Illustration: An architectural rendering of what 121 E Catherine may look like. 6 stories. Text: Issues of public interest - 121 E Catherine St. - Reclaiming Our History. 63 apartments. 2300 Square Feet Cultural &amp; Entrepreneurial Pursuits. $325k design &amp; build-out. $150k capacity building for neighborhood based organization."
  caption = "Plans for 121 E Catherine."
%}
...
{% include image.html
  src = "/assets/2023-04-17/budget/bicentennial.jpg"
  alt = "Presentation slide.  Image: The logo for Ann Arbor's bicentennial, which is mostly the text 'A200', in blue, with the first zero very large and inside of that is an oak tree in green. Slide Text:  Celebrating Ann Arbor. 1824-2024."
  caption = "The bicentennial logo."
%}
...
{% include image.html
  src = "/assets/2023-04-17/budget/downtown-patrol.jpg"
  alt = "Presentation slide. Illustration:  Three photos.  The first is two Ann Arbor firefighters posing in front of the downtown fire station.  The second is a stock photo of a woman working in an office.  The third is a booth operated by the Ann Arbor police at some sort of outdoor festival.  There is a crane in the background. There is also the logo of Supportive Connections, which is a highly stylized two people hugging to look like a heart, in purple and blue, and it says 'Supportive Connections: Supporting community + Connecting solutions.  Slide text:  Downtown safety. Walking builds relationships. Walking Improves Issues."
  caption = "A slide representing the downtown safety patrols."
%}
